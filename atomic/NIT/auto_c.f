...
!
	HDKT=4.7994D0
	ION_EN=196664.7000       !Correct
!
	OPEN(UNIT=10,FILE='C4.dat',STATUS='OLD',ACTION='READ')
	  I=0
          DO WHILE(1 .EQ. 1)
            STRING=' '
	    DO WHILE(STRING .EQ. ' ')
	    ...
	    I=I+1
            ...
            READ(STRING(K:),*)G(I),EDGE(I),REC_LOW(I),REC_HIGH(I)
            ...
            WRITE(30,'(A,2ES14.3)')TRIM(STRING),AD_LOW(I),AD_HIGH(I)
          END DO
1000      CONTINUE
	CLOSE(UNIT=10)
!
